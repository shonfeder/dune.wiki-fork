...
Even it is clear that OCaml is needed to differentiate the cases of a real problem (missing `.cmx` of an installed library) and an artificial one (local library), no new local-level feature is yet proposed for this.