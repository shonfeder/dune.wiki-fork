When releasing a new version, it may be useful to make a diff between the latest logs and the new ones, and parse them manually to check if dune is responsible for the errors.

We may also report failures to the package maintainers, but fixing them is not our responsibility.

## Log files of previous releases

### 3.X.Y

- [dune-3-24-0-Opam-CI.html](https://github.com/user-attachments/files/29529174/dune-3-24-0-Opam-CI.html)
- [dune-3-23-1-Opam-CI.html](https://github.com/user-attachments/files/28026575/dune-3-23-1-Opam-CI.html)
- [dune-3-23-0-Opam-CI.html](https://github.com/user-attachments/files/27420580/dune-3-23-0-Opam-CI.html)
